 ...
 * @author Kenneth
 */
public class AttachJobAction {

    private ProgressDialogX progressDialog;

    public void queryUserForJobs(UserPanel userPanel) {
    ...
    private void executeUpload(UserPanel userPanel, PladipusProcessingTemplate processingTemplate, File config) {
